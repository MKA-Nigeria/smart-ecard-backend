...
internal static class Startup
{
    ...
    internal static IServiceCollection AddBackgroundJobs(this IServiceCollection services, IConfiguration config)
    {
        ...
        services.AddSingleton<AppJobActivator, AppJobActivator>();
    ...
    private static IGlobalConfiguration UseDatabase(this IGlobalConfiguration hangfireConfig, string connectionString, IConfiguration config) => hangfireConfig.UseSqlServerStorage(connectionString, config.GetSection("HangfireSettings:Storage:Options").Get<SqlServerStorageOptions>());
